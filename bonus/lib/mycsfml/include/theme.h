...
*/
    ...
    #ifdef MINECRAFT
        #define LOGO "minecraftlogo.png"
        #define MUSIC "Minecraft.ogg"
        #define CLEAR_COLOR sfColor_fromRGB(70, 30, 5)
        #define FONT_TEXT "Minecraft.ttf"
    #endif

    #ifdef NICO
        #define LOGO "kawainicologo.png"
        #define MUSIC "NicoKaway.ogg"
        #define CLEAR_COLOR sfColor_fromRGB(240, 180, 230)
        #define TEXT_COLOR sfColor_fromRGBA(0, 0, 0, 200)
        #define TEXT_COLOR2 sfColor_fromRGBA(0, 0, 0, 50)
        #define FONT_TEXT "fast99.ttf"
    #endif

    #ifdef ETIPECH
        #define LOGO "etipechlogo.png"
        #define MUSIC "krustycrab.ogg"
        #define CLEAR_COLOR sfColor_fromRGB(200, 200, 200)
        #define TEXT_COLOR sfColor_fromRGBA(0, 0, 0, 200)
        #define TEXT_COLOR2 sfColor_fromRGBA(0, 0, 0, 50)
        #define FONT_TEXT "fast99.ttf"
    #endif
    ...
    #ifdef FIGHTER
        #define LOGO "fighterlogo.png"
        #define MUSIC "street_fighter.ogg"
        #define CLEAR_COLOR sfColor_fromRGB(30, 0, 0)
        #define TEXT_COLOR sfColor_fromRGBA(220, 100, 100, 200)
        #define TEXT_COLOR2 sfColor_fromRGBA(220, 100, 100, 200)
        #define COLOR1 sfColor_fromRGBA(255, 215, 50, 255)
        #define FONT_TEXT "karasu.ttf"
    #endif
